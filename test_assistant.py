...
def test_knowledge_base():
    ...
    if not os.path.exists("pieces_knowledge_base.json"):
        print("  ❌ pieces_knowledge_base.json not found")
        return False
...
def test_vector_store():
    ...
    if not os.path.exists("ap_faiss_index"):
        ...
        print("  Run: python prepare_knowledge_base.py")
        return False
...
def test_tools():
    ...
    try:
        from tools import find_piece_by_name, find_action_by_name
